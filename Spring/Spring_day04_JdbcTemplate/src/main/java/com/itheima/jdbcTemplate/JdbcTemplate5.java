...
//        获取容器对象
        ...
        AccountDao accountDao2=(AccountDao)ac.getBean("accountDao2");
//        根据用户ID查询账户
        Account accountByID = accountDao2.findAccountByID(8);
        System.out.println(accountByID);

//        根据用户名称查询账户
        Account accountByName = accountDao2.findAccountByName("猪小明");
